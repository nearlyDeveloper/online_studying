  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/admin"><i class="fa fa-home"></i> <span>Главная страница</span></a></li>
		<li><a href="/admin/cources"><i class="fa fa fa-graduation-cap"></i> <span>Управление курсами</span></a></li>
          <li><a href="/admin/users"><i class="fa fa fa-users"></i> <span>Пользователи</span></a></li>
      </ul>
    </section>
  </aside>
